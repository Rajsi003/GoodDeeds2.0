...
//         'https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=AIzaSyC-bUxVoyBBUzhpDIDLZLO3QFwssQhwkd4',
//         requestOptions
//       );
...
const Chat = () => {
  ...
  const generateBotResponse = async (history) => {
    ...
    try {
      const response = await fetch(
        'https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=AIzaSyC7mqgctINU21dI6dB06J4I6Kd_hGF1SZ0',
        requestOptions
      );
      const data = await response.json();
